...
const Hero = () => {
  return (
    ...
    >
      <div className="max-md:w-full  px-5 md:px-3 md:w-4/6  justify-center items-center text-start text-white   md:mx-auto">
        <h1 className="font-bold text-4xl md:text-7xl">Merrier Together</h1>
        <div className="py-5">
