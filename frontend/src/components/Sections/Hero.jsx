...
const Hero = () => {
  return (
    ...
    >
      <div className="max-md:w-full px-3 md:w-3/6  justify-center items-center text-start text-white   md:mx-auto">
        <h1 className="font-bold text-6xl">Merrier Together</h1>
        <div className="py-5">
